...
- 新增、查看、修改、删除菜谱
- 菜谱包含「主要食材 + 全部食材 + 详细菜谱 + 要点 + 标签 + 难度 + 菜系」
- 菜谱按分类分组展示，使用下拉菜单展开（页面初始默认收起）
- 支持菜名/食材/菜系/标签/难度搜索
...
- 管理员审核新账号（通过/拒绝）已集成到「账号管理」弹窗
- 侧边栏提供「账号管理」快捷选项，点击弹出独立界面修改当前账号信息与共享设置
...
│   ├── account_dialog.py    # 账号管理弹窗（含管理员审核）
